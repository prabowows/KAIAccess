...
class CariKereta extends StatefulWidget {
  CariKereta({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _CariKeretaState createState() => _CariKeretaState();
}

class _CariKeretaState extends State<CariKereta> {
  @override
  void initState() {
    super.initState();
    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext ctxt, int index) =>
              buildBodyKereta(ctxt, index, litems)),
    );
  }
